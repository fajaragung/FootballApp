...
import com.robotsoftwarestudio.footballapp.views.adapter.FavoriteTeamAdapter
...
class TabFavoriteTeam: Fragment() {

    private lateinit var v: View
    private val mListFavorites = mutableListOf<FavoritesTeam>()
    ...
    private fun inflateAdapter() {
        ...
        v.recycler_main.adapter = FavoriteTeamAdapter(activity!!.applicationContext, mListFavorites)
