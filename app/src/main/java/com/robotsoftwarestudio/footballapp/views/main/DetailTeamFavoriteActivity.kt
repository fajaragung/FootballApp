...
import com.robotsoftwarestudio.footballapp.views.fragmenttab.TabOverviewsFavoriteFragment
import com.robotsoftwarestudio.footballapp.views.tab.TabPlayersFravoriteFragment
...
class DetailTeamFavoriteActivity: AppCompatActivity() {
    ...
    companion object {
        ...
        lateinit var mTeams: FavoritesTeam
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mTeams = intent.extras.getSerializable("TEAMS") as FavoritesTeam
        ...
        try {
            sqlite.use {
                insert(FavoritesTeam.TABLE_NAME,
                        ...
                        FavoritesTeam.LEAGUE to mTeams.league,
    ...
    private fun setUpTab() {
        ...
        //set tab view
        adapter.setUPTab(TabOverviewsFavoriteFragment(), getString(R.string.Overviews))
        adapter.setUPTab(TabPlayersFravoriteFragment(), getString(R.string.Players))
