...
class NextMatchPresenter(private val view: EventsContract.View, private val apiRepositoryPresenter: ApiRepositoryPresenter,
    ...
    override fun getEventsLeague(id: String?) {
        ...
        compositeDisposable.add(apiRepositoryPresenter.eventsNextLeague(id)
                .observeOn(scheduler.ui())
                .subscribeOn(scheduler.io())
                .subscribeWith(object: ResourceSubscriber<EventsResponse>() {
                    override fun onComplete() { view.hideLoading() }

                    override fun onNext(t: EventsResponse) {
                        view.eventsLeague(t.events)
                        MainActivity.idlingResourceCounter = 0
                    }
